...
OB    + For the route `GET /`, return the message `Welcome to the payment system`.
OB  + **Create a new file [`api.test.js`](api.test.js):**
...
OB      API available on localhost port 7865
      ```
    + Terminal 2:
      ```powershell
OB      bob@dylan:~/8-api$  curl http://localhost:7865 ; echo ""
      Welcome to the payment system
OBOB      bob@dylan:~/8-api$
      bob@dylan:~/8-api$ npm test api.test.js

      > 8-api@1.0.0 test /root/8-api
OB      > ./node_modules/mocha/bin/mocha "api.test.js"
...
+ [x] 10. **Deep equality & Post integration testing**
  ...
  + **Server:**
    ...
    + Terminal 2:
      ```powershell
OB      bob@dylan:~$ curl http://localhost:7865/available_payments ; echo ""
...
OB    + 
    ## RESOURCES
OB    + [x] [Mocha documentation](https://intranet.alxswe.com/rltoken/Gx5mfX41__cc2hwepcl0aA)
...
OB    + [x] [Request](https://intranet.alxswe.com/rltoken/FcJfzr2jUJSj8Xp3z9L1wg)
OB    + [x] [How to Test NodeJS Apps using Mocha, Chia and SinonJS](https://intranet.alxswe.com/rltoken/HwB8gViDosy8znk7H9i4Pw)   
